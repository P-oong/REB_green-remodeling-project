...
def match_candidate(group, bd_counts):
    """
...
def main():
    ...
    summary_results.to_excel("./result/rule_based_matching_result_ver2.xlsx", index=False)
    print("\n결과가 './result/rule_based_matching_result_ver2.xlsx'에 저장되었습니다.")
